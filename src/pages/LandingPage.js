...
const LandingPage = () => {
  ...
  const [videoEnded, setVideoEnded] = useState(!!alreadySeen);
  const [showHero, setShowHero] = useState(!!alreadySeen);
  ...
  return (
    <div className="landing-page">
      ...
      {!videoEnded && (
        <div className={`intro-video-wrapper ${fadeOut ? 'fade-out' : ''}`} onClick={handleSkip}>
          <video
            ref={videoRef}
          ...
          />
          <div className="skip-hint">Click anywhere or press ESC to skip</div>
        </div>
      )}

      {/* Main Page Content - fades in after video */}
      <div className={`main-content-wrapper ${showHero ? 'visible' : ''}`}>
          ...
          <div className="container">
            ...
            <div className="grid grid-3">
              <div className="intro-card animate-fade">
                <div className="intro-icon"><i className="fas fa-graduation-cap"></i></div>
                <h3>Learn & Grow</h3>
              ...
              <div className="intro-card animate-fade" style={{ animationDelay: '0.1s' }}>
                <div className="intro-icon"><i className="fas fa-project-diagram"></i></div>
              ...
              <div className="intro-card animate-fade" style={{ animationDelay: '0.2s' }}>
                <div className="intro-icon"><i className="fas fa-users"></i></div>
                <h3>Community</h3>
        ...
        <section className="highlights-section section bg-gradient">
          <div className="container">
            <div className="section-title"><h2>Club Highlights</h2></div>
            <div className="grid grid-4">
              <div className="highlight-item">
                <div className="highlight-number">500+</div><p>Active Members</p>
              </div>
              <div className="highlight-item">
                <div className="highlight-number">50+</div><p>Projects Completed</p>
              </div>
              <div className="highlight-item">
                <div className="highlight-number">25+</div><p>Events Per Year</p>
              </div>
              <div className="highlight-item">
                <div className="highlight-number">10+</div><p>Publications</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="grid grid-3">
              <div className="event-card card animate-fade">
                ...
                <Link to="/events" className="read-more">Explore Events <FaArrowRight /></Link>
              </div>
          ...
          <div className="container">
            <div className="mission-card">
              <div className="mission-content animate-slide-left">
                ...
                <p>Discover our commitment to fostering innovation, collaboration, and excellence in AI and Data Science education.</p>
                <Link to="/overview" className="btn btn-primary">Learn Our Vision <FaArrowRight /></Link>
              </div>
        ...
        <section className="cta-section section bg-gradient">
          <div className="container text-center">
            ...
            <p>Be part of a thriving community of AI and Data Science enthusiasts.<br />Start your journey today!</p>
            <Link to="/join" className="btn btn-secondary btn-lg">Join Our Club <FaArrowRight /></Link>
          </div>
        </section>
